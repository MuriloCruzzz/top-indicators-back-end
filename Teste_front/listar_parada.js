...
function iniciarContadorComBaseNoTempo(tempoCriacao) {
    ...
    // Calcula a diferença entre o tempo atual e o tempo de criação
    var diferenca = tempoAtual - dataCriacao.getTime();

    // Inicia o contador com base na diferença de tempo
    contador = setInterval(function() {
        // Calcula o tempo decorrido desde o tempo de criação
        var tempoDecorrido = Date.now() - diferenca;
